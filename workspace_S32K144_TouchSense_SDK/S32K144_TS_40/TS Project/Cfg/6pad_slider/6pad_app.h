...
******************************************************************************/
			...
			#define FILTER_2_COEF_A0           -0.827271945972476
				...
				#define FILTER_3_COEF_B0           0.059190703818405
				#define FILTER_3_COEF_B1           0.059190703818405
				#define FILTER_3_COEF_A0           -0.881618592363189
			#endif
		#else
			// Define electrodes IIR filter parameters
			// ELECTRODES_SENSE_PERIOD   30
...
******************************************************************************/
	...
	#elif (TS_RAW_DATA_CALCULATION == OVERSAMPLING)
		// Electrode touch threshold relative to DC tracker value
		#define ELEC6_TOUCH_THRESHOLD_DELTA       15
		// Electrode release threshold relative to DC tracker value
		#define ELEC6_RELEASE_THRESHOLD_DELTA     10
	#else
...
******************************************************************************/
// Calculate number of samples, when module in active mode, max value 128
#define NUMBER_OF_ELECTRODE_SENSING_CYCLES_PER_SAMPLE_SLIDER_ACTIVE   (NUMBER_OF_ELECTRODE_SENSING_CYCLES_PER_SAMPLE_SLIDER_MULTIPLY * NUMBER_OF_ELECTRODE_SENSING_CYCLES_PER_SAMPLE_SLIDER_IDLE)
...
******************************************************************************/
	...
	#endif
	// Electrode touch threshold relative to DC tracker value
	#define SLIDER_ELEC_TOUCH_THRESHOLD_DELTA            200
#else
	#error Please select valid raw data calculation method in ts_cfg_general.h
#endif
 ...
 ******************************************************************************/
	...
	// Number from 1 to 6
	#define NUMBER_OF_HYSTERESIS_BLIND_POINTS 25

	// Difference data
	// Maximal amplitude of the difference data observed in freemaster
	#define NUMBER_OF_MAXIMAL_OBSERVED_DIFFERENCE 4000
	// Minimal amplitude of the difference data observed in freemaster
	#define NUMBER_OF_MINIMAL_OBSERVED_DIFFERENCE 2200

	// Addition data
	// Threshold of addition data
	#define SLIDER_ADDITION_DATA_THRESHOLD_DEFAULT 1800
#elif (TS_RAW_DATA_CALCULATION == AVERAGING)
	// Number of points above and below each threshold, where the slider is insensitive to change
	// Number from 1 to 6
